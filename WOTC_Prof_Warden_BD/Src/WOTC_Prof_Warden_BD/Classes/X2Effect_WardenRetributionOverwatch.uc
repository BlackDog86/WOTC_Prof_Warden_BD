class X2Effect_WardenRetributionOverwatch extends X2Effect_Persistent config(WardenSkills);
...
static function EventListenerReturn EventHandler(Object EventData, Object EventSource, XComGameState GameState, Name EventID, Object CallbackData)
{
	...
	local X2Effect_WardenRetributionOverwatch EffectTemplate;
	...
	EffectTemplate = X2Effect_WardenRetributionOverwatch(EffectState.GetX2Effect());
...
defaultproperties
{
	...
	EventName="TriggerWardenOverwatchAbility"
}